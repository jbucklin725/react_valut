...
class LoginHydroModalPopup extends React.Component {
        ...
        return (
            <div>
                <Modal isOpen={props.modal} toggle={props.toggle}
                    ...
                    {/* <ModalHeader toggle={props.toggle} className="bg-modal">
                        ...
                        <div className="lockModalPopup divTextCenter" responsive>
                            ...
                            <div>
                                {!props.isGAuthLoading ?
                                    <Button className="btn btn-success btn-verify" onClick={props.onSubmitGoogleAuthToken}>Verify</Button> : <LoadingOverlay
...
export default LoginHydroModalPopup;