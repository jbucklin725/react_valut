...
class CoSignerAuthModalPopup extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Modal className="authenticator" isOpen={true}
                        ...
                        <div className="lockModalPopup divTextCenter" responsive>
                            ...
                            <div>
                                {!props.isGAuthLoading ?
                                    <Button className="btn btn-success btn-verify" onClick={props.onSubmitGoogleAuthTokenForSharedVault}>Verify</Button> : <LoadingOverlay
...
export default CoSignerAuthModalPopup;