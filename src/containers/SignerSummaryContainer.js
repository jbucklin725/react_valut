...
class _SignerSummaryContainer extends React.Component {
...
export const SignerSummaryContainer = withRouter(connect(mapStatestoProps)(_SignerSummaryContainer));