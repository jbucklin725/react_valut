...
import  SharedVaultStatusComponent  from '../components/shared-vault-status-component/SharedVaultStatus.jsx';

class _sharedVaultStatusContainer extends React.Component {
    ...
    render() {
        ...
        return <SharedVaultStatusComponent
...
export const SharedVaultStatusContainer = withRouter(connect(mapStatestoProps)(_sharedVaultStatusContainer));