...
import  VaultSummaryComponent  from '../components/singleVaultSummary/VaultSummaryComponent';

class _VaultSummaryContainer extends React.Component {
...
export const VaultSummaryContainer = withRouter(connect(mapStatestoProps)(_VaultSummaryContainer));